...
package com.myasinmanager.spapi.client;

import com.amazon.SellingPartnerAPIAA.AWSSigV4Signer;
import com.amazon.SellingPartnerAPIAA.LWAAuthorizationSigner;
import com.amazon.SellingPartnerAPIAA.RateLimitConfiguration;
import com.google.common.util.concurrent.RateLimiter;
import com.myasinmanager.spapi.auth.ApiKeyAuth;
import com.myasinmanager.spapi.auth.Authentication;
import com.myasinmanager.spapi.auth.HttpBasicAuth;
import com.myasinmanager.spapi.auth.OAuth;
...
public class ApiClient {
    ...
    /**
     * Sets the RateLimiter A rate limiter is used to manage a high volume of
     * traffic allowing N requests per second
     *
     * @return Api client
     */
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            ...
            log.error("ERROR IN API --------------------- {},{},{},{},{},{},{}", response.message(), response.body(), response.cacheResponse(), response.priorResponse(), response.toString(), response.code(),response.challenges());
