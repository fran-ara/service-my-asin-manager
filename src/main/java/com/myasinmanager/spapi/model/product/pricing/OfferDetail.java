...
public class OfferDetail {
	...
	/**
	 * The subcondition of the item. Subcondition values: New, Mint, Very Good,
	...
	/**
	 * The maximum time within which the item will likely be shipped once an order
	 * has been placed.
	 * 
	 * @return shippingTime
	 **/
	 ...
	 * Box winners at any time per ASIN, one that is eligible for Prime and one that
	 * is not eligible for Prime.
	 * 
	...
	@Override
	public int hashCode() {
		return Objects.hash(myOffer, offerType, subCondition, sellerId, conditionNotes, sellerFeedbackRating,
				shippingTime, listingPrice, quantityDiscountPrices, points, shipping, shipsFrom, isFulfilledByAmazon,
				primeInformation, isBuyBoxWinner, isFeaturedMerchant);
	}
