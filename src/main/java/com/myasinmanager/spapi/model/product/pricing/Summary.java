...
public class Summary {
	...
	/**
	 * This price is based on competitive prices from other retailers (excluding
	 * other Amazon sellers). The offer may be ineligible for the Buy Box if the
	 * seller&#39;s price + shipping (minus Amazon Points) is greater than this
	 * competitive price.
	 * 
	...
	/**
	 * The suggested lower price of the item, including shipping and Amazon Points.
	 * The suggested lower price is based on a range of factors, including
	...
	/**
	 * A list that contains the sales rank of the item in the given product
	 * categories.
	 * 
	...
	@Override
	public int hashCode() {
		return Objects.hash(totalOfferCount, numberOfOffers, lowestPrices, buyBoxPrices, listPrice,
				competitivePriceThreshold, suggestedLowerPricePlusShipping, salesRankings, buyBoxEligibleOffers,
				offersAvailableTime);
	}
	...
	public String toString() {
		...
		sb.append("    suggestedLowerPricePlusShipping: ").append(toIndentedString(suggestedLowerPricePlusShipping))
				.append("\n");
