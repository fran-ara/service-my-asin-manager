...
public class ItemVendorDetailsByMarketplace {
	...
	@Override
	public int hashCode() {
		return Objects.hash(marketplaceId, brandCode, manufacturerCode, manufacturerCodeParent, productCategory,
				productGroup, productSubcategory, replenishmentCategory);
	}
