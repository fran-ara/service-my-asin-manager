...
public class ProductService {
	...
	public void insertData() {
		...
		ProductEntity p2 = ProductEntity.builder()
				...
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/751388/jarra-con-vidrio-con-tapa-de-metal-jv97230-good-good/")
				.asin("B0872PYYBS").category("House").tags("Christmas").notes("Expensive product")
				.currentBSR(new BigDecimal(10)).currentBBPrice(new BigDecimal(449.0)).date(new Date())
				.fbaSellerCount(2).roi(new BigDecimal(7.0)).netMargin(new BigDecimal(5.0)).build();
		...
		ProductEntity p3 = ProductEntity.builder()
				...
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/2167334/tarro-metalizado-de-ceramica-mickey-adulto-20-oz-fund-kids/")
		...
		ProductEntity p4 = ProductEntity.builder()
				...
				.title("Ps5 Mlb The Show 22").buyCost(new BigDecimal(1799.0))
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/2096137/ps5-mlb-the-show-22/")
				.asin("B0892PYYBS").category("House").tags("Videogames").notes("Expensive product")
				.currentBSR(new BigDecimal(1)).currentBBPrice(new BigDecimal(1799.0)).date(new Date())
				.fbaSellerCount(28).roi(new BigDecimal(100.0)).netMargin(new BigDecimal(24.0)).build();
		...
		ProductEntity p5 = ProductEntity.builder()
				...
				.title("Figura de Lujo Black Adam 12").buyCost(new BigDecimal(1049.0))
				.additionalCost(BigDecimal.ZERO)
		...
		ProductEntity p6 = ProductEntity.builder()
				...
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/1141788/celular-motorola-edge-20-5g-xt2143-1-color-negro-r9-telcel/")
		...
		ProductEntity p7 = ProductEntity.builder()
				...
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/2082513/playera-manga-corta-carter-s-modelo-3n125310-para-nina/")
		...
		ProductEntity p9 = ProductEntity.builder()
				...
				.asin("B0882PYYBS").category("Games").tags("Games").notes("Perfect gift")
		...
		ProductEntity p10 = ProductEntity.builder()
				...
				.additionalCost(BigDecimal.ZERO)
				.supplierLink("https://www.sears.com.mx/producto/2234061/arbol-de-navidad-kensingtone-fir-con-350-luces-led-2-13-m/")
				.asin("B0892PYYBS").category("House").tags("Christmas").notes("Expensive product")
