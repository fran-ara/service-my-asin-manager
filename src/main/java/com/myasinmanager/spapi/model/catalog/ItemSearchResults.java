...
public class ItemSearchResults {
	...
	/**
	 * The estimated total number of Amazon catalog items matched by the search
	 * query (only results up to the page count limit will be returned per request
	 * regardless of the number found). **Note:** The maximum number of items
	 * (ASINs) that can be returned and paged through is 1000.
	 * 
	 * @return numberOfResults
	 **/
	@ApiModelProperty(required = true, value = "The estimated total number of Amazon catalog items matched by the search query (only results up to the page count limit will be returned per request regardless of the number found).  **Note:** The maximum number of items (ASINs) that can be returned and paged through is 1000.")
	...
	/**
	 * If available, the &#x60;nextToken&#x60; and/or &#x60;previousToken&#x60;
