...
public class OfferType {
	...
	/**
	 * Contains pricing information that includes promotions and contains the
	 * shipping cost.
	 * 
	 * @return buyingPrice
	 **/
	...
	/**
	 * The fulfillment channel for the offer listing. Possible values: * Amazon -
	 * Fulfilled by Amazon. * Merchant - Fulfilled by the seller.
	 * 
	...
	@Override
	public int hashCode() {
		return Objects.hash(offerType, buyingPrice, regularPrice, businessPrice, quantityDiscountPrices,
				fulfillmentChannel, itemCondition, itemSubCondition, sellerSKU);
	}
