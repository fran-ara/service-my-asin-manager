...
public class ItemSummaryByMarketplace {
	...
	/**
	 * Identifier of the website display group associated with an Amazon catalog
	 * item.
	 * 
	...
	/**
	 * Display name of the website display group associated with an Amazon catalog
	 * item.
	 * 
	...
	@Override
	public int hashCode() {
		return Objects.hash(marketplaceId, brand, browseClassification, color, itemClassification, itemName,
				manufacturer, modelNumber, packageQuantity, partNumber, size, style, websiteDisplayGroup,
